...
init_ieeeP1451Project(void)
{
    ...
    const oid Scfree1_oid[] = { 1,3,6,1,4,1,7934,1451,2,13 };
    const oid Scfree2_oid[] = { 1,3,6,1,4,1,7934,1451,2,14 };
    const oid Scfree3_oid[] = { 1,3,6,1,4,1,7934,1451,2,15 };
    const oid Scfree4_oid[] = { 1,3,6,1,4,1,7934,1451,2,16 };
    const oid Scfree5_oid[] = { 1,3,6,1,4,1,7934,1451,2,17 };
    const oid Scfree6_oid[] = { 1,3,6,1,4,1,7934,1451,2,18 };
    ...
    const oid Acfree3_oid[] = { 1,3,6,1,4,1,7934,1451,2,7 };
    const oid Acfree4_oid[] = { 1,3,6,1,4,1,7934,1451,2,8 };
    const oid Acfree5_oid[] = { 1,3,6,1,4,1,7934,1451,2,9 };
  ...
  DEBUGMSGTL(("ieeeP1451Project", "Initializing\n"));
    ...
    // netsnmp_register_scalar(
    //     netsnmp_create_handler_registration("Scfree1", handle_Scfree1,
    //                            Scfree1_oid, OID_LENGTH(Scfree1_oid),
    //                            HANDLER_CAN_RONLY
    //     ));
    netsnmp_register_scalar(
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Temperature = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 11);
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Light = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 12);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Humidity = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 13);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Distence = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 14);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Accelerationx = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 15);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Accelerationy = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 16);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Accelerationz = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 17);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_HS = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 18);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_LoadVoltage = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 19);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_LoadCurrent = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 110);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_LoadPower = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 111);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
                          ...
                          netsnmp_request_info         *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
        /* STARTS */
        value_of_Pressure = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 112);
        // value_of_temperature = base_value_of_temperature 
        //                      + randl(TEMPERATURE_FLUCTUATION)
        //                      - TEMPERATURE_FLUCTUATION / 2;
                snmp_set_var_typed_value(requests->requestvb,
...
// int
// handle_Scfree1(netsnmp_mib_handler *handler,
//                           netsnmp_handler_registration *reginfo,
//                           netsnmp_agent_request_info   *reqinfo,
//                           netsnmp_request_info         *requests)
// {
...
//         case MODE_GET:
//         /* STARTS */
//         value_of_free1 = int_py_caller("ieeeP1451Command", "get_int", "(i)", "i", 112);
//         // value_of_temperature = base_value_of_temperature 
//         //                      + randl(TEMPERATURE_FLUCTUATION)
//         //                      - TEMPERATURE_FLUCTUATION / 2;
//                 snmp_set_var_typed_value(requests->requestvb,
