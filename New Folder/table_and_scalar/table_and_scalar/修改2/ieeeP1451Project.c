    ...
    case MODE_GET:
        for (request=requests; request; request=request->next) {
            ...
            case COLUMN_TESTVALUE:
                ...
                table_entry->value = int_py_caller("ieeeP1451Command", "set_channel", "(iii)", "i", *table_info->indexes->val.integer, *table_info->indexes->next_variable->val.integer, 0);
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                              table_entry->value);
                  // snmp_set_var_typed_value(requests->requestvb,
                  //                          ASN_INTEGER,
    ...
    case MODE_SET_ACTION:
        for (request=requests; request; request=request->next) {
            ...
            case COLUMN_TESTVALUE:
                ...
                table_entry->value = *(requests->requestvb->val.integer);

                int_py_caller("ieeeP1451Command", "set_channel_init", "(iii)", "i", *table_info->indexes->val.integer, *table_info->indexes->next_variable->val.integer, table_entry->value);
                // snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                //                              &value_of_P1451ROWSTATUS);
